...
lvim.keys.normal_mode["<Esc>"] = "<C-c"
lvim.keys.insert_mode["<Esc>"] = "<C-c"
lvim.keys.visual_mode["<Esc>"] = "<C-c"

vim.api.nvim_set_keymap("v", "<space>re", [[ <Esc><Cmd>lua require('refactoring').refactor('Extract Function')<CR>]],
